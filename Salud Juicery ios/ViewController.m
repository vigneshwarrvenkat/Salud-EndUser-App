...
- (void)viewDidLoad {
    ...
    [[UINavigationBar appearance] setBackgroundColor:[UIColor colorWithRed:0 green:153 blue:0 alpha:1]];
   // self.title = @"Back";
  ...
  //  SWRevealViewController *revealViewController = self.revealViewController;
    ...
    CoffeeViewController *coffeeVC = [[CoffeeViewController alloc]initWithNibName:@"CoffeeViewController" bundle:nil];
    coffeeVC.title = @"Coffees";
    ...
    YSLContainerViewController *containerVC = [[YSLContainerViewController alloc]initWithControllers:@[bowlsVC,juiceListVC,smootheesVC2,healthVC1,hotVC3,coffeeVC]
    ...
    UIBarButtonItem *rewards = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"rewards_1"] style:UIBarButtonItemStylePlain target:self action:@selector(tapRewards:)];
    ...
    UIBarButtonItem *Checkout = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"cart_1"] style:UIBarButtonItemStylePlain target:self action:@selector(tap:)];
...
//    // lbl2.text= @"0";
  ...
  //  lbl4.text= @"0";
   ...
   // UIBarButtonItem *dollar = [[UIBarButtonItem alloc] initWithCustomView:lbl3];
    ...
    toolBar.backgroundColor=[UIColor darkGrayColor];
    [toolBar setItems:@[ rewards, item ,cost,space, Checkout]];
...
//When the rewards button is tapped

- (void)tapRewards:(UIBarButtonItem *)item{
    NSLog(@"item : %@", item.title);
    //  self.category = item.title;
    ...
    LoyaltyViewController *wc = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"LoyaltyViewController"];
    [self.navigationController pushViewController:wc animated:YES];

...
- (IBAction)valuechangedBowl:(id)sender {
    
    self.valuecountBowl.text = [NSString stringWithFormat:@"%d",[[NSNumber numberWithDouble:[(UIStepper *)sender value]] intValue]];
}

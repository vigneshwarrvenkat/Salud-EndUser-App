...
{
    if (self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, 239.0, 51.0)]) {
        [self setInitialValues];
    }
...
- (void)setInitialValues
{
    ...
    // init left button
    decrementButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0, 0.0, 75.0, 30.0)];
    ...
    // background image
    backgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(74.0, 0.0, 75.0, 30.0)];
    ...
    // init right button
    incrementButton = [[UIButton alloc] initWithFrame:CGRectMake(150.0, 0.0, 75.0, 30.0)];
...
- (void)setFrame:(CGRect)frame
{
    ...
    [super setFrame:CGRectMake(frame.origin.x, frame.origin.y, 239.0, 51.0)];
}

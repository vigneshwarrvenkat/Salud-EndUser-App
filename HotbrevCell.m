...
- (IBAction)valuechangedHot:(id)sender {
    
    self.valuecountHot.text = [NSString stringWithFormat:@"%d",[[NSNumber numberWithDouble:[(UIStepper *)sender value]] intValue]];
}
*/
